...
export default function RegisterPage() {
  ...
  const [form, setForm] = useState({ first_name:'', last_name:'', email:'', password:'', user_type:'member' });
...
const S = {
  ...
  box: { width:'100%', maxWidth:440, background:'#fff', borderRadius:12, boxShadow:'0 4px 24px rgba(0,0,0,0.15)', padding:'32px 28px 24px' },
