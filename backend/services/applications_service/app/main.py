...
from services.applications_service.app.services.application_command_service import get_application_command_service
...
async def startup() -> None:
    ...
    await get_application_command_service().startup()

@app.on_event('shutdown')
async def shutdown() -> None:
    await get_application_command_service().shutdown()
